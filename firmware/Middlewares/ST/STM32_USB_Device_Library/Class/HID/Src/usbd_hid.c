...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgFSDesc[USB_HID_CONFIG_DESC_SIZ]  __ALIGN_END =
{
  ...
  0x01,         /*wItemLength: Total length of Report descriptor*/
  0x03,
...
__ALIGN_BEGIN static uint8_t HID_TOUCHSCREEN_ReportDesc[769]  __ALIGN_END =
{
                                ...
                                USBD_SetupReqTypedef *req)
{
  ...
  case USB_REQ_TYPE_CLASS :
    ...
    case HID_REQ_GET_REPORT:
      // printf("GET REPORT wValue: %04X\n", req->wValue);
      // printf("GET REPORT wLength: %04X\n", req->wLength);
      if((req->wValue >> 8) == 0x03){ // Send feature report
        uint8_t CTP_Report[2] = {0x44, 0x0A};
        USBD_CtlSendData (pdev, CTP_Report, 2U);
      }
      break;
  ...
  case USB_REQ_TYPE_STANDARD:
    ...
    case USB_REQ_GET_DESCRIPTOR:
      ...
      {
        len = MIN(769 , req->wLength);
        pbuf = HID_TOUCHSCREEN_ReportDesc;
      }
